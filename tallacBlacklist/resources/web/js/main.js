...
var AppRouter = Backbone.Router.extend({
    ...
    tallac:function () {
        $('#content').html( new Blacklist.TallacView().render().el );
        $('ul.nav > li').removeClass('active');
        $('li > a[href*="/blacklist/index.html"]').parent().addClass('active');
    }
...
tpl.loadTemplates(['home', 'status', 'topology', 'header', 'switch', 'switch-list', 'switch-list-item', 'host', 'host-list', 'host-list-item', 'port-list', 'port-list-item', 'flow-list', 'flow-list-item'],
    function () {
        ...
        $(document).ready(function () {
            ...
            app.navigate("blacklist/index.html", true);
...
function swlUpdate() {
	...
	swlT = setTimeout("swlUpdate()", 3000);
}
